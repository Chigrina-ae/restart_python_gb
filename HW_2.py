...
x = abs(int(input('Введите первое натуральное число X от 1 до 1000 за Петю')))
y = abs(int(input('Введите второе натуральное число Y от 1 до 1000 за Петю')))
if x < 1 or x > 1000 or y < 1 or y > 1000:
    ...
    stop = 0
    while stop != 1:
        i = abs(int(input('Введите первое натуральное число X от 1 до 1000 ')))
        j = abs(int(input('Введите второе натуральное число Y от 1 до 1000 ')))
        if i * j == P and i + j == S:
